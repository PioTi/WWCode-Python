...
print ('Your Order : '+customer_order.upper())
storeDrinks = ['Coke','Sprite','Royal']
homeDrinks = ['RC','7UP']

if customer_order.lower() in (a.lower() for a in storeDrinks):
	print ('Got it!')
elif customer_order.lower() in (a.lower() for a in homeDrinks):
	print ('Please wait for a while!')
else:
	print('Sorry we dont sell that. We only have '+', '.join(storeDrinks),', '.join(homeDrinks))
